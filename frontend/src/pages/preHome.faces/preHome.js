...
import mangoLogo from '../../assets/images/mango@2x.avif'; 
...
export default function PreHome() {
    ...
    const handleSubmitLang = async (event) => {
        event.preventDefault();

        console.log("Langue choisie : ", lang);

        try {
            const response = await fetch('http://localhost:3000/api/postLang', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({ lang }), // Envoi correct de { lang }
            });
            ...
            if (response.ok) {
                ...
                console.error("Une erreur s'est produite dans la réception des données !");
            }
        } catch (error) {
  ...
  return (
    <div className='page_preHome'>


        <div className='logoAndTitle'>
            <div className='logoAndTitle_align'>
                <div className='logo'>
                    <img src={mangoLogo} alt='image_logo_mango' />
                </div>
                <div className='title'>
        ...
        <div className='mutipleChoises'>
            <div className='lable_multipleChoise'>
                <label for='lang'>Séléctionnez un pays ou une région</label>
            </div>
        ...
        <div className='select_multipleChoise'>
            <select name="langs" className="selectWithImage" value={lang} onChange={e=>setLang(e.target.value)}>
            <option id='option_multipleChoise_toChange' value={""}></option>
            <option id='option_multipleChoise_toChange' value={""}>Séléctionnez un pays ou une région</option>
    <optgroup label="A">
